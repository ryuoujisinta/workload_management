...
describe('TimesheetTable', () => {
  ...
  const tasks = [
    { id: 't1', name: 'Task 1', project: 'Proj A', targetMonth: '2023-10' }
  ]
  ...
  it('renders tasks and dates correctly', () => {
    render(<TimesheetTable tasks={tasks} dates={dates} initialWorkloads={[]} />)
  ...
  it('shows APPROVED status and disables inputs if workload is approved', () => {
    ...
    render(<TimesheetTable tasks={tasks} dates={dates} initialWorkloads={workloads as any} />)
